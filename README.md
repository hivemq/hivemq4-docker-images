...
| HIVEMQ_ALLOW_ALL_CLIENTS | true | Whether the default packaged allow all extension should be enabled or not. If this is not set to true, the extension will be prior to starting the broker. |
