...
| HIVEMQ_ALLOW_ALL_CLIENTS | true | Whether the default packaged allow all extension should be enabled or not. If this is set to false, the extension will be deleted prior to starting the broker. |
