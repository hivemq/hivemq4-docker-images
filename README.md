...
NOTE: Please consider using the [Kubernetes Operator](https://docs.hivemq.com/hivemq-operator/index.html) instead, as it makes production deployment of HiveMQ much easier.
